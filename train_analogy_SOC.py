...
# dataloader for test
test_dataloader = TestDataLoader("../benchmarks/SOC2/", "link")
...
trainer.run()
analogy.save_checkpoint('../checkpoint_soc/analogy.ckpt')

# test the model
analogy.load_checkpoint('../checkpoint_soc/analogy.ckpt')
